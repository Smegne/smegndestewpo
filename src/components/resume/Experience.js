      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="mt-6 md:mt-14 w-full border-l-[6px] border-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="WORLD"
            des={<b>Designed and developed responsive and dynamic web applications using React, Node.js, PHP, MySQL, and JavaScript. Built and deployed multiple full-stack projects, including file-sharing platforms, chat applications, and admin dashboards. Implemented secure authentication with JWT and user management systems. Optimized database queries and backend performance for better scalability. Created mobile-friendly UIs using Bootstrap, Tailwind CSS, and MediaQuery. Integrated third-party APIs (e.g., TMDB API) into applications. Managed hosting and deployment using Netlify, Infinity Free, and custom servers. Collaborated with teams and clients to deliver custom web solutions.</b>}
          />
          <ResumeCard
            title="Lead Developer – Liveshare File-Sharing Platform"
            subTitle="Personal Project | 2024"
            result="ETHIOPIA"
            des={<b>Developed a file-sharing system for students, supporting PDFs, videos, and images. Designed a secure login system using PHP and MySQL. Implemented a real-time chat feature using WebSockets. Ensured smooth and responsive UI/UX using modern frontend technologies like Tailwind CSS and Bootstrap. Integrated secure file encryption methods to protect user uploads. Deployed the system on a custom domain with optimized server performance.</b>}
          />
          <ResumeCard
            title="Full-Stack Developer – Stack Overflow Clone"
            subTitle="Personal Project | 2024"
            result="ONLINE"
            des={<b>Built a Q&A platform where users can ask and answer questions. Designed a user-friendly UI using React and Tailwind CSS. Developed a RESTful API backend with Node.js and MySQL. Implemented secure user authentication with JWT. Ensured real-time updates using WebSockets. Integrated a voting and commenting system to enhance user engagement. Optimized database indexing for better search functionality.</b>}
          />
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="mt-6 md:mt-14 w-full border-l-[6px] border-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            result="UPWORK"
            des={<b>Developed and deployed custom web applications for clients on Upwork and other freelance platforms. Designed responsive and interactive UIs using React, Bootstrap, and Tailwind CSS. Built and maintained secure backend systems using Node.js, PHP, and MySQL. Integrated payment gateways and third-party APIs in e-commerce platforms. Ensured SEO optimization, security, and performance improvements for clients’ websites. Provided post-deployment support and maintenance.</b>}
          />
          <ResumeCard
          ...
          <ResumeCard
            ...
            subTitle="Upwork"
            result="UPWORK"
            des={<b>Built a loan application system with secure user registration and verification. Developed an automated loan approval process based on predefined criteria. Integrated real-time notifications and secure data handling. Deployed and maintained the system for client operations. Designed an admin dashboard for loan management and tracking. Ensured compliance with financial security regulations. Provided documentation and training for client usage.</b>}
          />
        </div>
      </div>
    </motion.div>
